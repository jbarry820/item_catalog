...
def fbconnect():
    ...
    url = 'https://graph.facebook.com/oauth/access_' \
          'token?grant_type=fb_exchange_token&client_id=' \
...
def categoryItemJSON(category_id, item_id):
    category = session.query(Category).filter_by(id=category_id).one()
    Item_looking_for = (session.query(Item).filter_by(id=item_id,
...
def showItems(category_id):
    ...
    if ('username' not in login_session or
        ...
        return render_template('publicitem.html', items=items_in_category,
                               category=category, creator=creator)
    else:
        return render_template('menu.html', items=items_in_category,
                               category=category, creator=creator)
...
def newItem(category_id):
    ...
    if login_session['user_id'] != category.user_id:
        return "(<script>function myFunction() {alert('You are not ' \
                 'authorized to add item items to this category. ' \
...
def editItem(category_id, item_id):
    ...
    if login_session['user_id'] != category.user_id:
        return "(<script>function myFunction() {alert('You are not ' \
                 'authorized to edit item items to this category. ' \
...
def deleteItem(category_id, item_id):
    ...
    if login_session['user_id'] != category.user_id:
        return "(<script>function myFunction() {alert('You are not ' \
                 'authorized to delete item items to this category. ' \
                 'Please create ' \
